...
let NumericTextBoxComponent = NumericTextBoxComponent_1 = class NumericTextBoxComponent {
    constructor(intl, renderer, localizationService, ngZone, hostElement, rtl) {
        this.intl = intl;
        ...
        this.handleInput = () => {
            ...
            if (this.pressedKey === Keys.numpad_dot) {
            ...
            if (parsedValue !== value || !this.focused) {
...
], NumericTextBoxComponent.prototype, "id", void 0);
tslib_1.__decorate([
    Input(),
...
NumericTextBoxComponent = NumericTextBoxComponent_1 = tslib_1.__decorate([
    Component({
        ...
        providers: [
            ...
            { provide: NG_VALIDATORS, useExisting: forwardRef(() => NumericTextBoxComponent_1), multi: true } /* tslint:disable-line */
        ],
