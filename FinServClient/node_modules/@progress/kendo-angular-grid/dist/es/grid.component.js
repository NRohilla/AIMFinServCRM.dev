...
var GridComponent = /** @class */ (function () {
    function GridComponent(supportService, selectionService, wrapper, groupInfoService, groupsService, changeNotification, detailsService, editService, filterService, pdfService, responsiveService, renderer, excelService, ngZone, scrollSyncService, domEvents, rtl, columnResizingService, changeDetectorRef, columnReorderService, columnInfoService, navigationService) {
        ...
        this.columnsContainer = new ColumnsContainer(function () { return _this.columnList.filterSort(function (column) { return !_this.isHidden(column) && _this.matchesMedia(column); }); });
    ...
    GridComponent.prototype.reorder = function (_a) {
        ...
        this.updateColumnIndices({ source: source, target: target, before: before });
    ...
    GridComponent.prototype.columnInstance = function (column) {
        ...
        if (typeof column === 'number') {
            instance = this.columnList.filter(function (item) { return !item.isColumnGroup && !item.hidden; })[column];
        }
    ...
    GridComponent.prototype.resizeCheck = function () {
        ...
        if (window.innerWidth !== this.cachedWindowWidth && this.columnsContainer.refresh()) {
            this.ngZone.run(function () {
                _this.cachedWindowWidth = window.innerWidth;
