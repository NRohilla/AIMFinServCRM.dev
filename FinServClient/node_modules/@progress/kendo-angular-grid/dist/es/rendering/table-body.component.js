...
var TableBodyComponent = /** @class */ (function () {
    function TableBodyComponent(detailsService, groupsService, changeNotification, editService, localization, ngZone, renderer, element, domEvents, selectionService, columnInfoService, idService, navigationService) {
        var _this = this;
    ...
    TableBodyComponent.prototype.selectionCheckboxId = function (itemIndex) {
        return this.idService.selectionCheckboxId(itemIndex);
    };
    ...
    TableBodyComponent = tslib_1.__decorate([
        Component({
        ...
        tslib_1.__metadata("design:paramtypes", [DetailsService,
            GroupsService,
