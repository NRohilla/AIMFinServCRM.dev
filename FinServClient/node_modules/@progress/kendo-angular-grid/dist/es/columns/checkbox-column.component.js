 ...
 *
 * The template has to contain [`SelectionCheckboxDirective`]({% slug api_grid_selectioncheckboxdirective %}).
 *
 * @example
 * ```ts-preview
 *
...
var CheckboxColumnComponent = /** @class */ (function (_super) {
    ...
    CheckboxColumnComponent_1 = CheckboxColumnComponent;
    ...
    CheckboxColumnComponent = CheckboxColumnComponent_1 = tslib_1.__decorate([
        Component({
            providers: [
                {
                    provide: ColumnBase,
                    useExisting: forwardRef(function () { return CheckboxColumnComponent_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
