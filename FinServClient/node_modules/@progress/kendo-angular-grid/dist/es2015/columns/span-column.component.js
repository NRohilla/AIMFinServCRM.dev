 ...
 * you can use a [cell template]({% slug api_grid_celltemplatedirective %}).
 *
 * ```html-no-run
 * <kendo-grid-span-column>
 ...
 * ```
 */
let SpanColumnComponent = SpanColumnComponent_1 = class SpanColumnComponent extends ColumnBase {
    constructor(parent) {
        super(parent);
        /*
         * @hidden
...
], SpanColumnComponent.prototype, "hidden", null);
tslib_1.__decorate([
    Input(),
    tslib_1.__metadata("design:type", Boolean),
    tslib_1.__metadata("design:paramtypes", [Boolean])
...
SpanColumnComponent = SpanColumnComponent_1 = tslib_1.__decorate([
    Component({
        providers: [
            {
                provide: ColumnBase,
                useExisting: forwardRef(() => SpanColumnComponent_1) // tslint:disable-line:no-forward-ref
            }
        ],
