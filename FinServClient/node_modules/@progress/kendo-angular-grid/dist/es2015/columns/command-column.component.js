 ...
 * ```
 */
let CommandColumnComponent = CommandColumnComponent_1 = class CommandColumnComponent extends ColumnBase {
    constructor(parent) {
        super(parent);
        this.parent = parent;
    }
...
CommandColumnComponent = CommandColumnComponent_1 = tslib_1.__decorate([
    Component({
        providers: [
            {
                provide: ColumnBase,
                useExisting: forwardRef(() => CommandColumnComponent_1) // tslint:disable-line:no-forward-ref
            }
        ],
