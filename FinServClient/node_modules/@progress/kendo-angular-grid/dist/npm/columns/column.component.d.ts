...
export declare class ColumnComponent extends ColumnBase {
    ...
    /**
     * Determines if the column can be dragged to the group panel. Default value is `true`.
     * If set to `false`, it is possible to group by the column field via the API.
     */
    groupable: boolean;
    /**
