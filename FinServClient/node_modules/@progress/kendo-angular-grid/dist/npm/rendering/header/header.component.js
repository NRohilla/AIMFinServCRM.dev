...
var single_popup_service_1 = require("../../filtering/menu/single-popup.service");
...
var rules = utils_1.and(ofColumnType, reorderable, notInSpanColumn, notSameElement, sameParent, utils_1.not(lastNonLocked));
/**
 * @hidden
 */
var HeaderComponent = /** @class */ (function () {
    ...
    Object.defineProperty(HeaderComponent.prototype, "showFilterMenu", {
        get: function () {
            return filterable_1.hasFilterMenu(this.filterable);
        },
        enumerable: true,
        configurable: true
    });
    ...
    HeaderComponent.prototype.attachTargets = function () {
        ...
        this.targetSubscription.add(enterStream.pipe(tap_1.tap(function (_a) {
        ...
        }), switchMap_1.switchMap(this.trackMove.bind(this, leaveStream, dropStream)), map_1.map(function (e) { return mergeObjects(e, { before: _this.calculateBefore(e) }); }), map_1.map(this.normalizeTarget.bind(this)), tap_1.tap(this.enter.bind(this)), switchMapTo_1.switchMapTo(dropStream.pipe(takeUntil_1.takeUntil(leaveStream.pipe(tap_1.tap(this.leave.bind(this))))), function (outerArgs, _) { return outerArgs; }))
    ...
    HeaderComponent.prototype.trackMove = function (leaveStream, dropStream, e) {
        ...
        if (changed && isFirst) {
            return e.draggable.drag
                .pipe(takeUntil_1.takeUntil(leaveStream), takeUntil_1.takeUntil(dropStream), map_1.map(function (_a) {
