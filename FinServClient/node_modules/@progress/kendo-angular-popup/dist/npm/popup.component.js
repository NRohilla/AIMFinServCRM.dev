...
var PopupComponent = /** @class */ (function () {
    ...
    PopupComponent.prototype.ngAfterViewChecked = function () {
        ...
        this._zone.runOutsideAngular(function () {
            ...
            _this.repositionSubscription = fromPromise_1.fromPromise(_this.resolvedPromise)
    ...
    Object.defineProperty(PopupComponent.prototype, "currentOffset", {
        ...
        set: function (offset) {
            if (!this._currentOffset || util_1.isDifferentOffset(this._currentOffset, offset)) {
