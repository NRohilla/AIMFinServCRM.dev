...
@Component({
    selector: `qualifications-personal-details`,
    templateUrl: './app.qualifications.personaldetails.html',
    animations: [routerTransition()],
    providers: []
})
export class QualificationsPersonalDetailsComponent implements OnInit {
